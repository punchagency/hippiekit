...
export default function PasswordResetOtpModal({
  ...
  return (
    <div className="fixed inset-0 bg-gray-900 z-50 flex items-center justify-center">
      <div className="w-full max-w-[440px] min-h-screen bg-white overflow-auto shadow-[0_0_50px_rgba(0,0,0,0.3)]">
        <section className="mt-20 mx-[25.45px] font-family-poppins text-[#222] pb-20">
          {/* Title */}
          <div className="mb-2">
            <h1 className="text-[30px] font-bold">OTP Verification</h1>
          ...
          <div className="mt-[60px] text-[16px]">
            ...
            <p className="mt-2">
              ...
              <button
                ...
                disabled={timer > 0 && timer < 300}
                className="underline font-medium cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Resend
              </button>
            </p>
          ...
          <Button
            ...
            className="w-full text-[#FFF] mt-[178px] disabled:opacity-50"
