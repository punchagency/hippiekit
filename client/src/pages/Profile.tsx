...
const Profile = () => {
  ...
  return (
    <section className="z-10 font-family-roboto pb-20">
      ...
      <div className="w-[80px] h-[80px] sm:w-[100px] sm:h-[100px] rounded-[63px] border-4 sm:border-[6px] border-[#FFF] object-cover mx-auto mt-[-40px] sm:mt-[-50px] overflow-hidden">
        <img
          src={user?.profileImage || profileImgSample}
          alt="Profile"
      ...
      <div className="flex items-center justify-center gap-2 mt-2 px-4">
        <Button className="bg-transparent w-full max-w-[107px] text-sm sm:text-base border border-primary text-primary">
          <EditIcon /> Edit Profile
        </Button>
        <Button
          onClick={handleLogout}
          className="bg-red-500 w-full max-w-[107px] text-sm sm:text-base text-white hover:bg-red-600"
        >
          Logout
        </Button>
      </div>
